...
public class Client {
    ...
    protected String getServerAddress() {
        ConsoleHelper.writeMessage("Write the IP address to connect.");
        return ConsoleHelper.readString();
    }

    protected int getServerPort() {
        ConsoleHelper.writeMessage("Write the port of the address to connect.");
    ...
    public void run() {
        ...
        try {
            ...
            if (clientConnected) {
                ...
                ConsoleHelper.writeMessage("For exit type \"exit\".");
    ...
    public class SocketThread extends Thread {
        ...
        protected void informAboutAddingNewUser(String userName) {
            ConsoleHelper.writeMessage("The user has joined the chat: " + userName);
        }

        protected void informAboutDeletingNewUser(String userName) {
            ConsoleHelper.writeMessage("The user has left the chat: " + userName);
        }
